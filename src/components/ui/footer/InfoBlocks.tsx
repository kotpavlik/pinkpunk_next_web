...
const ALFA_ICONS: string[] = [
    '/images/alfa_icons/white-01.png',
    '/images/alfa_icons/white-02.png',
    '/images/alfa_icons/white-03.png',
    '/images/alfa_icons/white-04.png',
    '/images/alfa_icons/white-05.png',
    '/images/alfa_icons/white-06.png',
...
export const AlfaPaymentIcons = memo(function AlfaPaymentIcons({
    placement,
}: {
    placement: 'columnDesktop' | 'belowMapMobile'
}) {
    const outer =
        placement === 'columnDesktop'
            ? 'relative mt-auto hidden w-full shrink-0 justify-center pb-1 pt-4 sm:pt-6 md:flex md:pt-8 md:pb-0'
            : 'relative flex w-full shrink-0 justify-center px-2 pt-6  md:hidden'

    return (
        <div className={outer}>
            <div className="box-border flex max-w-full min-w-0 flex-row flex-wrap items-center justify-center gap-x-1.5 gap-y-1 px-1 sm:max-w-[50vw] sm:gap-x-2.5 sm:gap-y-1.5 sm:px-2 md:gap-x-3 md:gap-y-2 md:px-3">
                {ALFA_ICONS.map((src) => (
                    <div key={src} className="group flex shrink-0 items-center justify-center">
                        <Image
                            src={src}
                            alt=""
                            width={96}
                            height={40}
                            sizes="(max-width: 639px) 32px, (max-width: 1023px) 48px, 72px"
                            unoptimized
                            className="h-3.5 w-auto max-h-3.5 max-w-full object-contain opacity-50 grayscale transition-[filter,opacity] duration-300 sm:h-5 sm:max-h-5 md:h-7 md:max-h-7 lg:h-8 lg:max-h-8 hover:opacity-100 hover:grayscale-0 hover:brightness-110"
                        />
                    </div>
                ))}
            </div>
    ...
    return (
        <>
            <div className="flex w-full min-w-0 min-h-0 flex-1 flex-col">
                        ...
                        {!isModalOpen && !isMobile && <div>
                            ...
                            <p className='text-sm font-cabinet-grotesk lowercase text-gray-500 mt-4'>
                                <a href="mailto:pinkpunk.company@gmail.com" className="flex items-center gap-2 ">
                                    ...
                                    </svg> pinkpunk.company@gmail.com
                                </a>
                ...
                <AlfaPaymentIcons placement="columnDesktop" />
            </div>
